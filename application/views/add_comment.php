<div class="row">
    <form class="col s12" name="dasform" id="dasform">
      <div class="row">
        ...
        <div class="input-field col s6">
          <input id="post_Id" name="post_Id"  value="<?php echo $post_Id; ?>" type="text" class="validate">
        </div>
...
<!-- Dropdown Trigger -->
  ...
  <!-- Dropdown Structure -->
  <ul id='dropdown1' class='dropdown-content emoji-list' name="emojis" >
    <li>&#x1F004;</li>
  <li>&#x1F0CF;</li>
  <li>&#x1F170;</li>
  <li>&#x1F171;</li>
